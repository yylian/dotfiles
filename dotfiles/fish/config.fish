...
# local backup
function backup; rsync --verbose --recursive --delete-before --whole-file --times --exclude=".DS_Store" --exclude=".Trash/" ~/Library/Mobile\ Documents/com\~apple\~CloudDocs/ yylian@192.168.1.36:~/backup; end
